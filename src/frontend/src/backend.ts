...
export class Backend implements backendInterface {
    ...
    async createEntry(arg0: DiaryEntry): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllDatesWithEntries(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDatesWithEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntriesByDate(arg0: string): Promise<Array<DiaryEntry>> {
        if (this.processError) {
            try {
    ...
    async updateEntry(arg0: DiaryEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
